    ...
    return (
        ...
        <main className="w-full p-8">
            <div className="flex justify-between items-center">
                ...
                <Link className="px-2 py-1 rounded bg-blue-100" href="/dashboard/batch/create">Add batch</Link>
            </div>
            <div className="mt-6 mb-4">
                <button className="mx-2 border-b-4 border-white hover:border-blue-100">Fresh</button>
                <button className="mx-2 border-b-4 border-white hover:border-blue-100">Near expiry</button>
                <button className="mx-2 border-b-4 border-white hover:border-blue-100">Expired</button>
            </div>
            <div className="my-2">
